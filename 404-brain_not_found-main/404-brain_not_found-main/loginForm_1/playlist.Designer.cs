namespace loginForm_1
{
    partial class Playlist
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Create a simple placeholder Panel in place of the AxWindowsMediaPlayer COM control
            axWindowsMediaPlayer1 = new Panel();
            ...
            // BeginInit removed for placeholder control
            ...
            // 
            // axWindowsMediaPlayer1 (replaced with a placeholder Panel to avoid COM interop dependency)
            //
            axWindowsMediaPlayer1.Enabled = true;
            axWindowsMediaPlayer1.Location = new Point(255, 62);
            axWindowsMediaPlayer1.Name = "axWindowsMediaPlayer1";
            // OcxState removed for SDK build compatibility; placeholder control used instead
            ...
            btnUploadCover.Click += btnUploadCover_Click_1;
            // 
            // picCoverArt
            // 
            ...
            // EndInit not required for placeholder control
        ...
        private Control axWindowsMediaPlayer1;
